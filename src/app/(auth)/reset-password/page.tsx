  ...
  if (!token) {
    return (
      <div className="text-center">
        ...
        <p className="text-red-700 font-medium mb-2">Невалиден линк</p>
  ...
  if (success) {
    return (
      <div className="text-center">
        ...
        <p className="text-green-700 font-medium mb-2">Паролата е сменена!</p>
        <p className="text-gray-500 text-sm mb-6">
          Можеш да влезеш с новата си парола.
        </p>
        <Link
          href="/login"
          className="inline-block bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 px-6 rounded-xl transition duration-150 shadow-md hover:shadow-lg"
        >
          Към вход
        </Link>
      </div>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 to-purple-50">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">HODLClub</h1>
