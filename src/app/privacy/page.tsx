          ...
          <div className="prose prose-gray max-w-none space-y-8 text-gray-700 leading-relaxed">
            ...
            <section>
              ...
              <p>
                ...
                криптовалутите и блокчейн технологиите. Платформата се управлява от физическо или
                юридическо лице, базирано в Република България.
              </p>
              <p className="mt-2">
                За въпроси, свързани с личните ви данни, можете да се свържете с нас на:{' '}
                <strong>privacy@hodlclub.bg</strong>
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-3">
                За упражняване на правата си се свържете с нас на <strong>privacy@hodlclub.bg</strong>.
